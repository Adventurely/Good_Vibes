...
export const TUNING = {
 ...
 "bodies": [
  ...
  },
  {
   ...
   "species": "cat",
   "climate": "micro",
   "notes": "The big rock at the near end of the Belt: 400 km across and almost no weight to it, so a ship matches speeds with it rather than falling into orbit. Escape is 50 m/s at the ground — a hard jump would do it — which is why the harbour is a rendezvous and the yards are bolted to the rock. Repairs, salvage and cheap parts."
  },
  {
   "id": "whisker",
   "name": "Whisker",

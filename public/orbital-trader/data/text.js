 ...
 "tutorial": [
  {
   "step": "castoff",
   "title": "Cast off",
   "body": "You are tied up at Tessel. Open the Shipyard and cast off: the ship drops into a slow circle around the world, going the way the world goes."
  },
  {
   "step": "mark",
   "title": "Write down a burn",
   "body": "Tap your path to leave a mark on it. Nothing is spent yet. A mark is a burn you have written down for later, and you can move it, change it, or scrap it."
  },
  {
   "step": "pull",
   "title": "Pull forward until you reach Bramble",
   "body": "Drag the forward handle, or use the steppers, until the far end of your path touches Bramble's reach. Then open Target, pick Bramble, and press Aim for it to tidy the last few metres per second."
  },
  {
   "step": "warp",
   "title": "Wind the clock to the burn",
   "body": "Use 'warp to burn'. The clock runs, the sky turns, and everything stops a moment before the burn so you can watch it go."
  },
  {
   "step": "dock",
   "title": "Get close, get slow, tie up",
   "body": "Inside Bramble's reach, aim for kissing distance inside the harbour mouth, then burn back to shed speed. Close enough and slow enough, and Bramble takes your lines."
  }
 ],

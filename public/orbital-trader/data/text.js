...
export const NARRATIVE = {
 "glossary": [
  ...
  },
  {
   ...
   "tip": "The four ways to push. Forward and back are along the way you are already going, and move the far end of your path. Out and in are square across it: they turn the path without adding anything to your speed along it."
  },
  {
   "term": "a transfer",
 ...
 "ports": {
  ...
  "maw": {
   "blurb": "Something at the edge of the system, six astronomical units out, with a ring of glittering dust around a hole in the sky and a small blue star going round it. The star is all anybody has ever seen from here: it appears to circle nothing, and has done for as long as anyone has looked. A Builder station keeps station on the nothing, aimed inward, and has done for longer than there have been people to notice. That is everything anyone knows.",
   "arrival": [
 ...
 "events": {
  ...
  "distress": [
   "They come out for you without being asked twice, which is its own kind of comment. Nobody mentions the fee; the fee mentions itself.",
   "The harbour master remembers your ship, remembers what you paid last time, and works out what half of everything is before the ship is even alongside.",
   "A long quiet ride home behind somebody else's engine, with your own tank ticking as it cools and nothing to do but think about it."
  ],
  ...
  "mawArrival": "You have come as far as anyone goes. The Dancer is overhead and enormous and the wrong colour for this far out, and it is going round something. The ring of dust is there, exactly where the Builders pointed their station, and at the middle of it there is nothing at all — a hole the size of a hill with a system's worth of light bending round it.\nThe station keeps its distance and does not drift. Nothing is holding it. You check three times.\nThe Builders put a silent thing out here and aimed it at a hole in the sky. They left no doors, no stairs, no seats, and no explanation. Why does anyone build a place to watch from, if not to tell somebody what they saw?",
  "skimDamage": [
   "Something lets go aft with a sound you feel through the deck. The shield held. The frame under it did not, quite, and there is a seam that was not there this morning.",
   "The second pass finds the seam and opens it. Nothing is venting and nothing is on fire, but the hull rings wrong when you knock on it now, and you will knock on it.",
   "A whole plate goes. You spend an hour in the lock with resin and a lamp, and it holds, and you both know what it is holding. One more of those and there is nothing to patch."
  ],
  ...
  "firstRendezvous": "Tsuki takes the numbers off the board without being asked: how close the path actually comes, and how fast you are closing. Neither is the range, which she says is the number people watch when they want to be reassured rather than informed. You match speed with a thing that has no pull at all and hold there, and the hold is the whole trick.",
  "questCollected": "Signed for, counted, and put away. That is the job done.",
  "firstSalvage": "Nothing is holding you here. Tsuki matches the thing's drift without being asked, holds the ship a few hundred metres off it, and says nothing at all while somebody gets a line across. The hull you are tied to has been going round this same path since before you could fly, and it will go round it again after you have gone."
 },
 "opening": {
 ...
 "tutorial": [
  {
   "step": "look",
   "title": "Welcome to space — look around",
   "body": "Uncle Theo to the Skipper. You made it to space! Now comes the hard part. I can show you the ropes if you help me pick up a present for Aunt Nellie.\n\nFirst, look around. Drag the map to pan around your ship."
  },
  {
   "step": "find",
   "title": "Find Slate — zoom out",
   "body": "Slate is one of Tassel's two moons: it goes round the planet you are going round, a little farther out.\n\nZoom out until you can see it and the circle it travels on — scroll, pinch, or press the minus key."
  },
  {
   "step": "focus",
   "title": "Focus Slate",
   "body": "There it is. Tap Slate.\n\nThe map will follow whatever you focus. Planets, moons and your own ship, all the same way."
  },
  {
   "step": "back",
   "title": "Back to the ship",
   "body": "Now get back to the Skipper. Press F, or tap the ◎ button by the chart."
  },
  {
   "step": "mark",
   "title": "Plan a burn",
   "body": "Good. Let's get that present. The white line is the path you are flying now. Tap it a little way ahead of your ship and choose 'Plan a burn'.\n\nA burn is firing the engine to speed up or slow down. A planned burn is a point on your path where that happens: nothing fires yet, and you can change it until the clock gets there.\n\nDon't worry where it goes. We'll fix that next."
  },
  {
   "step": "push",
   "title": "Push the far side out to Slate",
   "body": "Four arrows appeared around the flame. Green adds speed, orange takes it back.\n\nHere is the whole trick, and everything after this is it again: a burn moves the FAR side of your orbit, not the side you are on. Press green once and watch — the line moves half an orbit away from the flame.\n\nKeep going until that far side reaches Slate's circle. What it costs comes off the Fuel gauge."
  },
  {
   "step": "slide",
  ...
  },
  {
   ...
   "body": "You reach Slate's circle, but not Slate. It is a moon, still going round Tassel while you climb, so it will have moved on.\n\nTwo orange diamonds show it: one on your road where it crosses Slate's circle, one where Slate will really be. Slide the burn earlier or later until they sit together.\n\nThe line under this card counts the gap down. A red cross means that road hits the ground — keep sliding."
  },
  {
   "step": "skip",
  ...
  },
  {
   ...
   "body": "You've made it to Slate, and the chart has swung round to follow it: this map is Slate's now, not Tassel's.\n\nYou are going too fast for Slate to hold you, so the path bends past and straight back out. Plan a burn at the low point, where you pass closest, and press orange one press at a time until the path closes into a loop.\n\nGone too far, and the loop shrinks toward the ground? Press green once."
  },
  {
   "step": "lower",
   "title": "Bring the loop inside docking range",
   "body": "Wow. You're a natural.\n\nNow get close enough to dock: the high point of your orbit has to sit inside Slate's docking range.\n\nSame trick as before — a burn moves the far side. Burn back at the low point, then press the anchor."
  },
  {
   "step": "buy",
   "title": "One pebble, mind the price",
   "body": "The Market has moon pebbles on the shelf — the cheapest thing here. Theo left you just enough for one.\n\nBuy it."
  },
  {
   "step": "leave",
  ...
  },
  {
   "step": "home",
   "title": "Bring it home",
   "body": "Now bring it home. Docking with Tassel works the same way: bring your high point inside Tassel's docking range.\n\nSame trick as before."
  },
  {
   "step": "done",
   "title": "There you are",
   "body": "First trip. First trade. And you made it home.\n\nNellie will love it."
  }
 ],
 "shipNames": [
  "Skipper"
 ...
 "captainLines": {
  ...
  "onStranded": [
   ...
   "Dry. A distress call costs half of everything and no time at all; a tow costs less and takes months. It has happened to better pilots, most of whom deny it."
  ]
 },
 "logTemplates": {
  ...
  "rescued": "Distress call answered by {port}. Half the purse: {cost}.",

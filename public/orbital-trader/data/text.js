...
export const NARRATIVE = {
  ...
  "roles": [
   {
    ...
    "empty": "No engineer. The Emberkin train them and the Emberkin keep them, and one does not come aboard for money."
   },
   {
    "id": "navigator",
    "name": "Navigator",
    ...
    "empty": "No navigator. The cats have the eyes for it and the Belt is where you would have to go and ask."
   },
   {
    "id": "appraiser",
    "name": "Appraiser",
    ...
    "empty": "No appraiser. The frogs study for a lifetime and are in no hurry; you would have to give them a reason."
   }
  ],
  "note": "Nobody signs on yet. Three jobs in the line pay in a person and none of them are flyable until there is somewhere to take one on."
 },
 "events": {
  "tollOffer": [
   {
 ...
 "tutorial": [
  ...
  {
   "step": "buy",
   "title": "One pebble, and mind the price",
   "body": "The Market has the beach pebbles on it, the cheapest thing on the shelf. Theo has left you just about enough for one. Buy it."
  },
  {
   "step": "leave",

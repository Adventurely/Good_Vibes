 ...
 *
 * The key matches the `art` field in the shared ENEMIES.
 */
 ...
 *
 * The key matches the `art` field in the shared BUILDINGS.
 */
...
/* Sixteen by sixteen, one per terrain kind in shared/grid.js.
 *
...
/* Eight by eight, drawn on the ground line so they sit in a row without
   ...
   the key matches the id in the shared rules. */
...
/* Eight by eight, same as the materials, because they sit in the same kind of
   ...
   matches the id in shared SALVAGE. */
